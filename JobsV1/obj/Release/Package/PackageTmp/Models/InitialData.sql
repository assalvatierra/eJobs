...
insert into Customers([Name],[Email],[Contact1],[Contact2],[Remarks]) values('<< New Customer >>','--','--',' ',' ');
insert into Customers([Name],[Email],[Contact1],[Contact2],[Remarks]) values('RealBreeze-Davao','realbreezedavao@gmail.com','Elvie/0916-755-8473','','');
