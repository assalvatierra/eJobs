...
values
('11-25-2018',1,'Test Job 101',10,1,'TEST DATA 0101',3,'N/A',1,1,5000),
('11-28-2018',1,'Item scheduling',3,1,'TEST DATA 0102',3,'N/A',1,1,3000);
...
values
(1,1,2,'Car Rental sample data R1',5000,5000,5000,'Sample only. Disregard once seen on production',1,'11-15-2018','08-22-2018'),
(1,1,2,'Car Rental sample data R2',3000,3000,3000,'Sample only. Disregard once seen on production',1,'11-26-2018','08-29-2018'),
(2,1,2,'SUV Rental R1',2000,2000,2000,'Sample only. Disregard once seen on production',1,'11-27-2018','11-28-2018'),
(2,1,2,'SUV Rental R2',1000,1000,1000,'Sample only. Disregard once seen on production',1,'11-29-2018','11-30-2018');
