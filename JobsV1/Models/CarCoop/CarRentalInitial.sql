...
values
	-- Van -- 
	(1, 'Vehicle (Toyota Grandia GL) for Rent in Palawan',
	'Toyota Grandia GL for rent in Palawan best suited for business and family occassions',
	'Comfortable 10 Seater van for rent in Palawan. Best Price for the budget.'
	),

	-- Nissan Premium -- 
	(2, 'Vehicle (Nissan Urvan Premium) for Rent in Palawan',
	'Nissan Urvan Premium for rent in Palawan best suited for business,family, tour and travel occassions',
	'Highroof van that can accommodate 14pax with individual reclining seats.'
	),

	-- SUVs -- 
	(3, 'SUV (Sports Utility Vehicle) for Rent in Palawan',
	'SUV for rent in Palawan for your business needs and personal needs.',
	'SUV can accommodate 7 persons suited for personal and business travels.'
	),

	-- AUVs-- 
	(4, 'MPV (Multi purpose vehicle) for Rent in Palawan',
	'MPV/AUV - Toyota Innova -  for Rent in Palawan for comfortable travel.',
	'Toyota Innova is a vehicle for family and business use. Can accomodate up to 8 persons.'
	),

	-- Sedan -- 
	(5, 'Sedan for Rent in Palawan',
	'Sedan - Honda City - for rent in Palawan for your business and travel needs.',
	'Sedan is a practical vehicle for light travel and can be used for self drive or with driver.'
	),

	-- Pickup -- 
	(6, 'Pickup for Rent in Palawan',
	'Pickup 4x4 for rent in Palawan for difficult terrain or bigger luggages.',
